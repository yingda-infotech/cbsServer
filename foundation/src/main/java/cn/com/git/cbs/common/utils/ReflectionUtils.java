...
public class ReflectionUtils {
	 ...
	 *            对象实例
	 * @param propertyName
	 *            方法名，支持多级，如对象名.对象名.方法
	 * @return 调用对象getter方法后的返回值
	 */
	 ...
	 *            方法名称
	 * @param parameterTypes 方法参数类型
	 * @return Method 该对象的对应方法的Method对象
	 */
	...
	/**
	 * 通过反射, 获得Class定义中声明的泛型参数的类型, 注意泛型必须定义在父类处 如无法找到, 返回Object.class. 如：
	 * {@code
	 * <pre>
	 * public UserDao extends HibernateDao<User>
	 * ReflectionUtils.getClassGenricType(UserDao.class) == User.class
	 * </pre>
	 * }
	 *
	 * @param clazz
	 *            需要获取泛型参数的Class
	 * @param <T> 泛型参数的类型
	 * @return 泛型参数的类型，如找不到泛型参数，则返回Object.class
	 */
	 ...
	 * ReflectionUtils.getClassGenricType(UserDao.class,0) == User.class;
	 * </pre>
	 * }
	 *
	 * @param clazz
