...
public class PropertiesUtils {
	 ...
	 * @param key
	 *            键值
	 * @return 取出Property，但以System的Property优先,取不到返回空字符串（""）
	 */
	 ...
	 * @param key
	 *            键值
	 * @return 取出Property，但以System的Property优先,如果都为Null则抛出异常
	 * 
	 */
	...
	/**
	 * 取出String类型的Property，但以System的Property优先.如果都为Null则返回默认值
	 * 
	 * @param key
	 *            键值
	 * @param defaultValue
	 *            默认值
	 * @return 取出Property，但以System的Property优先,如果都为Null则返回默认值
	 */
